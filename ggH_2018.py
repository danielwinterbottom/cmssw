...
# with command line options: Configuration/GenProduction/python/TAU-RunIIFall18wmLHEGS-00001-fragment.py --fileout file:TAU-RunIIFall18wmLHEGS-00001.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename TAU-RunIIFall18wmLHEGS-00001_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(1000)\nprocess.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1566649197%100) -n 200
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TAU-RunIIFall18wmLHEGS-00001-fragment.py nevts:200'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TAU-RunIIFall18wmLHEGS-00001.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TAU-RunIIFall18wmLHEGS-00001_inLHE.root'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1566649197%100)
